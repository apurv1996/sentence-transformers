...
class BatchBinaryClassificationEvaluator(SentenceEvaluator):
    """
    ...
    def __call__(self, model, embd1, embd2, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        scores = self.compute_metrices(model, embd1, embd2)
    ...
    def compute_metrices(self, model, embeddings1, embeddings2):
